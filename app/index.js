  ...
  prompting: function () {
    ...
    var prompts = [
      ...
      },
      {
        type: 'list',
        name: 'css',
        message: 'Do you want any CSS libraries?',
        choices: [{
          name: 'reset.css',
          value: 'reset'
        }, {
      ...
      },
      {
        type: 'input',
        name: 'buildPath',
        message: 'Where would you like to build files?',
        default: 'dist'
      },
      {
        type: 'input',
        name: 'defaultPort',
        message: 'What port number should we use?',
        default: '9000'
      }
    ];
    ...
    this.prompt(prompts, function (answers) {
      ...
      this.includeBootstrap = (answers.css === 'bootstrap');

      this.buildPath = answers.buildPath;
      this.defaultPort = answers.defaultPort;
  ...
  writing: {
    ...
    reset: function() {
      if(this.includeReset) {
        this.copy('reset.css', 'app/styles/reset.'+(this.includeSass ? 'scss' : 'css'));
      }
    },
